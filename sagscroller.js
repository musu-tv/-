...
navpanel: {height:'16px', downarrow:'http://allfilmonline.cc/js/sagscroller/down.gif', opacity:0.6, title:'Смотреть Дальше', background:'#000000'},
loadingimg: {src:'http://allfilmonline.cc/js/sagscroller/ajaxloading.gif', dimensions:[100,15]}
}
